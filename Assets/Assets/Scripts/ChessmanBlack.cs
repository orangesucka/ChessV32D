...
public class ChessmanBlack : MonoBehaviour
{
    //References
    ...
    //Needs work
    public Mesh BlackBishop, BlackKing, BlackKnight, BlackPawn, BlackQueen, BlackRook;
    //public GameObject WhiteBishop, WhiteKing, WhiteKnight, WhitePawn, WhiteQueen, WhiteRook;
...
/*
            //case "WhiteBishop": GetComponent<MeshFilter>().mesh = WhiteBishop; break;
            case "WhiteBishop": WhiteBishop = GetComponent<GameObject>(); break;
            //case "WhiteKing": GetComponent<MeshFilter>().mesh = WhiteKing; break;
            case "WhiteKing": WhiteKing = GetComponent<GameObject>(); break;
            //case "WhiteKnight": GetComponent<MeshFilter>().mesh = WhiteKnight; break;
            case "WhiteKnigh": WhiteKnight = GetComponent<GameObject>(); break;
            //case "WhitePawn": GetComponent<MeshFilter>().mesh = WhitePawn; break;
            case "WhitePawn": WhitePawn = GetComponent<GameObject>(); break;
            //case "WhiteQueen": GetComponent<MeshFilter>().mesh = WhiteQueen; break;
            case "WhiteQueen": WhiteQueen = GetComponent<GameObject>(); break;
            //case "WhiteRook": GetComponent<MeshFilter>().mesh = WhiteRook; break;
...
*/
    ...
    {
        GameBlack sc = controller.GetComponent<GameBlack>();
        ...
        if (sc.PositionOnBoard(x, y) && sc.GetPosition(x, y).GetComponent<ChessmanBlack>().player != player)
        {
    ...
    private void PointMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            else if (cp.GetComponent<ChessmanBlack>().player != player)
            {
                MovePlateAttackSpawn(x, y);
            }
        }
    ...
    private void PawnMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            if (sc.PositionOnBoard(x + 1, y) && sc.GetPosition(x + 1, y) != null &&
                sc.GetPosition(x + 1, y).GetComponent<ChessmanBlack>().player != player)
            {
    ...
    private void MovePlateSpawn(int matrixX, int matrixY)
    {
        ...
        MovePlateBlack mpScript = mp.GetComponent<MovePlateBlack>();
